...
const ui = {
  ...
  btn: { padding:'10px 14px', border:'1px solid #e2e8f0', borderRadius:12, background:'#fff', cursor:'pointer', fontSize:12 },
  select: { padding:'10px 14px', border:'1px solid #e2e8f0', borderRadius:12, background:'#fff', fontSize:16 },
  legendWrap:{ display:'flex', gap:20, marginTop:12, marginBottom:16 },
  chip: { padding:'6px 12px', border:`1px solid ${THEME.border}`, borderRadius:14, background:THEME.panel, lineHeight:1.2, boxShadow:'0 1px 2px rgba(0,0,0,.04)', fontSize:12 },
