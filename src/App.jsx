...
const ui = {
  ...
  headerRow: { display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:12 },
  h1: { fontSize:28, fontWeight:800, margin:0 },
  toolbar: { display:'flex', flexWrap:'wrap', alignItems:'center', gap:12 },
  btn: { padding:'10px 14px', border:'1px solid #e2e8f0', borderRadius:12, background:'#fff', cursor:'pointer', fontSize:8 },
  select: { padding:'10px 14px', border:'1px solid #e2e8f0', borderRadius:12, background:'#fff', fontSize:16 },
  legendWrap: { display:'flex', gap:20, fontSize:16, marginTop:8 },
