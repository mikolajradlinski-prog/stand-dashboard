...
const ui = {
  ...
  headerRow: { display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:16 },
  h1: { fontSize:28, fontWeight:800, margin:0 },
  toolbar:   { display:'flex', flexWrap:'wrap', alignItems:'center', gap:16 },
  ...
  legendWrap:{ display:'flex', gap:16, fontSize:14 },
